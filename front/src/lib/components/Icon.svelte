<script lang="ts">
	...
	const icons: Record<string, string> = {
		...
		//  Périmètres — jeu proposé dans l'écran /admin/patrimoine. Ajouté le
		//  13/08/2026 : aucune icône du jeu existant ne disait « parking », « cave »,
		//  « arbre », « escalier » ni « ascenseur ».
		...
		'stairs':             `<path d="M3 21h4v-4h4v-4h4V9h4V5h3"/><path d="M3 21V5"/>`,
