<script lang="ts">
	...
	// Icônes Lucide inline (outline, stroke 1.5, viewBox 0 0 24 24)
	//
	// Exception assumée : `whatsapp` n'est pas une icône Lucide mais une marque.
	// Elle porte donc son propre `fill` (vert officiel) et `stroke="none"`, qui
	// neutralisent les attributs de l'enveloppe <svg> plus bas. Elle vit ici
	// parce qu'elle était dessinée SIX fois dans le dépôt, avec DEUX tracés
	// différents (08/08/2026) — un logo n'a pas à être recopié.
	const icons: Record<string, string> = {
		...
		'bell':             `<path d="M10.27 21a2 2 0 0 0 3.46 0"/><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/>`,
		...
		'hard-hat':         `<path d="M2 18a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v2z"/><path d="M10 10V5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5"/><path d="M4 15v-3a6 6 0 0 1 6-6h4a6 6 0 0 1 6 6v3"/>`,
		...
		'sliders-horizontal': `<line x1="21" x2="14" y1="4" y2="4"/><line x1="10" x2="3" y1="4" y2="4"/><line x1="21" x2="12" y1="12" y2="12"/><line x1="8" x2="3" y1="12" y2="12"/><line x1="21" x2="16" y1="20" y2="20"/><line x1="12" x2="3" y1="20" y2="20"/><circle cx="12" cy="4" r="2"/><circle cx="10" cy="12" r="2"/><circle cx="16" cy="20" r="2"/>`,
...
<svg
	...
	aria-hidden="true"
>
	{@html icons[name] ?? icons['help-circle']}
</svg>
