...
<div class="legal-editor-wrap">
	...
	<div class="legal-toolbar">
		{#if !sourceMode}
			...
			<div class="sep"></div>
			<button type="button" title="Annuler" on:click={() => editor.chain().focus().undo().run()}
				>↩</button
			>
			<button type="button" title="Rétablir" on:click={() => editor.chain().focus().redo().run()}
				>↪</button
			>
		{/if}
...
<style>
	...
	:global(.legal-content-editable .tiptap) {
		outline: none;
	}
	:global(.legal-content-editable .tiptap p) {
		margin: 0 0 0.5rem;
	}
	:global(.legal-content-editable .tiptap p:last-child) {
		margin-bottom: 0;
	}
	:global(.legal-content-editable .tiptap h2) {
		font-size: 1.15rem;
		font-weight: 600;
		margin: 1rem 0 0.4rem;
	}
	:global(.legal-content-editable .tiptap h3) {
		font-size: 1rem;
		font-weight: 600;
		margin: 0.8rem 0 0.3rem;
	}
	:global(.legal-content-editable .tiptap ul, .legal-content-editable .tiptap ol) {
		padding-left: 1.5rem;
		margin: 0.3rem 0;
	}
	:global(.legal-content-editable .tiptap li) {
		margin-bottom: 0.15rem;
	}
	:global(.legal-content-editable .tiptap blockquote) {
		border-left: 3px solid var(--color-border);
		padding-left: 0.75rem;
		color: var(--color-text-muted);
		margin: 0.5rem 0;
	}
	:global(.legal-content-editable .tiptap hr) {
		border: none;
