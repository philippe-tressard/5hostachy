...
export const PAGES: PageDef[] = [
    ...
    onglets: [{ id: 'prestataires', label: '\u{1F527} Prestataires', descriptif: 'Intervenants et contrats d\'entretien de la résidence.' }, { id: 'consommations', label: '\u{1F4A7} Consommations', descriptif: 'Suivi des relevés de compteurs et abonnements de la résidence.' }] },
    ...
    onglets: [{ id: 'liste', label: '\u{1F4CB} Liste', descriptif: 'Les événements, du plus lointain au plus ancien.' }, { id: 'kanban', label: '\u{1F5C3}️ Kanban', descriptif: 'Organisation visuelle des événements par statut.' }, { id: 'archives', label: '\u{1F4C1} Archives', descriptif: 'Actualités et événements archivés.' }] },
	...
	{ id: 'espace-cs', href: '/espace-cs',       nom: 'Espace CS',            titre: 'Espace Conseil Syndical (CS)', navLabel: 'Espace CS',      icone: 'shield-half',         descriptif: "Tableau de bord des membres du Conseil Syndical (CS) : suivi des comptes, reporting, relance syndic et demandes d'accès — réservé au Conseil Syndical. Les tickets de la résidence se traitent depuis la page <a href=\"/tickets\">Tickets</a>.",
    onglets: [{ id: 'validations', label: '✅ Comptes & accès', descriptif: 'Comptes en attente, demandes d\'accès et validations à traiter.' }, { id: 'reporting', label: '\u{1F4CA} Reporting', descriptif: 'Synthèses et indicateurs : kanban, tableau des tickets, prestataires, renouvellements de contrats et relance syndic.' }, { id: 'annonces-hall', label: '\u{1F4C4} Annonces Hall', descriptif: 'Créez une annonce à afficher dans le hall des bâtiments : PDF à la charte de la résidence, envoyé par mail aux membres du CS concernés, puis conservé dans l\'historique.' }, { id: 'annuaire', label: '\u{1F4D2} Annuaire CS & Syndic', descriptif: 'Coordonnées des membres du CS et du syndic.' }] },
