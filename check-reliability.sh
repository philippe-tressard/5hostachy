...
# Extraites dans `lib-verdicts.sh` le 11/08/2026 : ce fichier dépassait 500 lignes
# et le garde-fou de modularité a refusé le push en y ajoutant C19. Le self-test
...
# shellcheck source=lib-collecte.sh
. "$(dirname "$0")/lib-collecte.sh"
