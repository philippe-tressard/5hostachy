...
| `*/15 * * * *` `check-reliability.sh` | contrôles de fiabilité **C1 à C24** (C8 retiré le 17/07/2026 : il causait les pertes qu'il devait prévenir) + alerte e-mail sur `FAIL`, digest quotidien sur `WARN` |
