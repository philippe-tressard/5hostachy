...
#  Même préfixe encore : la synthèse d'un contrat est sortie du même fichier,
#  pour la même raison (modularité, rang 1) et sur la même couture. C'est aussi
#  le seul point d'entrée payant du dépôt — il mérite d'être lisible seul.
