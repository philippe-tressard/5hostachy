...
FAQ_INITIALE = [
    ...
    ("📱 Application 5Hostachy", "L'application fonctionne-t-elle hors connexion ?", "5Hostachy est une application compatible PC, tablette et mobile nécessitant une connexion internet. Elle peut s'installer sur l'écran d'accueil de votre téléphone comme une vraie app, mais les fonctions principales (tickets, documents, calendrier) restent inaccessibles sans réseau.", 12),
]

FAQ_COMPLEMENTAIRE = [
    ("📱 Application 5Hostachy", "Pourquoi mes anciens tickets n'apparaissent plus dans la liste principale ?", "Les tickets résolus ou annulés passent automatiquement dans l'onglet <strong>🗂️ Archives</strong> de la page Tickets, après un délai fixé par le conseil syndical. Cela garde la liste principale centrée sur les demandes encore actives, sans rien perdre : tout reste consultable dans les archives.", 13),
    ("📱 Application 5Hostachy", "Que voit le conseil syndical lorsqu'il traite mon ticket ?", "Le conseil syndical traite les demandes depuis la page <strong>Tickets</strong>, où il voit le détail, l'historique, ainsi que le <strong>prénom / nom</strong> et le <strong>bâtiment</strong> du demandeur, afin de situer rapidement le contexte. Il peut y changer le statut et ajouter un commentaire de suivi. L'<strong>Espace CS</strong>, lui, en donne la vue d'ensemble dans son onglet Reporting.", 14),
