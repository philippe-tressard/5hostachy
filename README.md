...
- **Prestataires & Contrats** — Gestion des prestataires et contrats d'entretien. Deux contrats sont **désignés** depuis la fiche de copropriété — l'**assurance** et le **mandat de syndic** — qui y affiche alors l'organisation, les dates, le numéro et le document signé. Le cabinet est un prestataire ; ses **membres** restent dans l'annuaire, d'où partent les e-mails
