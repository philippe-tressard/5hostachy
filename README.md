...
- **Administration** — Paramétrage site, comptes, sauvegardes, SMTP, WhatsApp, **assistant IA** (fournisseur, clé et garde-fous ; la clé n'est jamais renvoyée par l'API)
